                        ...
                        <div class="shop_toolbar_wrapper">
                         ...
                         <div class="row shop_wrapper">
                                ...
                                <div class="single_product">
                                    <div class="product_thumb">
                                        ...
                                        <div class="quick_button">
                                            <a href="{{url('/shop/product')}}"title="quick_view">Xem sản phẩm</a>
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a class="primary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product22.jpg')}}" alt=""></a>
                                        <a class="secondary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product23.jpg')}}" alt=""></a>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    ...
                                    <div class="product_content grid_content">
                                        <h3><a href="{{url('/shop/product')}}">Beats Solo Wireless</a></h3>
                                        <span class="current_price">£60.00</span>
                                        <span class="old_price">£86.00</span>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a class="primary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product25.jpg')}}" alt=""></a>
                                        <a class="secondary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product26.jpg')}}" alt=""></a>
                                    ...
                                    <div class="product_content grid_content">
                                        <h3><a href="{{url('/shop/product')}}">Apple iPad with Retina</a></h3>
                                        <span class="current_price">£60.00</span>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a class="primary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product2.jpg')}}" alt=""></a>
                                        <a class="secondary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product1.jpg')}}" alt=""></a>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a class="primary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product3.jpg')}}" alt=""></a>
                                        <a class="secondary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product4.jpg')}}" alt=""></a>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a class="primary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product5.jpg')}}" alt=""></a>
                                        <a class="secondary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product6.jpg')}}" alt=""></a>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a class="primary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product9.jpg')}}" alt=""></a>
                                        <a class="secondary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product10.jpg')}}" alt=""></a>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a class="primary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product11.jpg')}}" alt=""></a>
                                        <a class="secondary_img" href="{{url('/shop/product')}}"><img src="{{asset('fontend/img/product/product12.jpg')}}" alt=""></a>
